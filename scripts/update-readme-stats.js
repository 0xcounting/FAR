...
const rows = [
  ...
  ['— linked to a CoinGecko coin', `${n(counts.dtiLinked)} (${pct(counts.dtiLinked, counts.dtiTokens)})`],
  ['\u2003\u2003of which rule-proposed / model-inferred / human-accepted', `${n(counts.dtiProposed)} / ${n(counts.dtiInferred)} / ${n(counts.dtiAccepted)}`],
  ['— chain recovered despite redaction', `${n(counts.dtiChainRecovered)} (${pct(counts.dtiChainRecovered, counts.dtiTokens)})`],
