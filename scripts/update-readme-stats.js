...
const rows = [
  ...
  ['\u2003\u2003address-derived (exact)', `${n(counts.dtiExact)}`],
  ['\u2003\u2003rule-proposed / model-inferred / human-accepted', `${n(counts.dtiProposed)} / ${n(counts.dtiInferred)} / ${n(counts.dtiAccepted)}`],
  ['\u2003\u2003wrong name-links removed by the address', `${n(counts.dtiNameLinksSuppressedByAddress)}`],
  ['— chain identified', `${n(counts.dtiChainRecovered)} (${pct(counts.dtiChainRecovered, counts.dtiTokens)})`],
